  ...
  FIXTURES: [
    ...
    },
    {
      ...
      description: "<h2>Iteration #1</h2>" +
          "Основная задача – формирование правильного мировоззрения, которое поможет эффективно применять инструмент, вместо того чтобы вступать с ним в борьбу.</br> " +
          "Ровно за один день мы рассмотрим основные элементы фреймоврка и напишем простое приложение, с тем чтобы превратить информацию в знания ;)",
      image: "assets/images/static/event.jpg",
